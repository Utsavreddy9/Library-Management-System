...
public class AdministratorFrame extends javax.swing.JFrame {
	...
	private static final long serialVersionUID = -3405149791659032162L;
	public AdministratorFrame() {
      ...
      private void initComponents() {
        ...
        jLabel1.setText("Logged in as an Administrator");
        ...
        addNewBook.setForeground(new java.awt.Color(0, 51, 255));
        ...
        editLibMember.setForeground(new java.awt.Color(0, 51, 255));
        ...
        newLibMember.setForeground(new java.awt.Color(0, 51, 255));
        ...
        addBookCopy.setForeground(new java.awt.Color(0, 51, 255));
        ...
        searchISBN.setForeground(new java.awt.Color(0, 51, 255));
        ...
        isbnPanelDisplay.setBackground(new java.awt.Color(204, 255, 204));
                            ...
                            .addGroup(bookPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(bookPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(bookPanelLayout.createSequentialGroup()
                                        .addGap(357, 357, 357)
                                        .addGroup(bookPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(authorStreet, javax.swing.GroupLayout.DEFAULT_SIZE, 222, Short.MAX_VALUE)
                                            .addComponent(authorLastName)
                                    ...
                                    .addComponent(authorCity, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(bookPanelLayout.createSequentialGroup()
                ...
                .addGroup(bookPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(bookPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(bookPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
                            .addComponent(authorStreet, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(18, 18, 18)
                .addGroup(bookPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(bookPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(bookPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(authorCity, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(bookPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(bookPanelLayout.createSequentialGroup()
                                .addGap(34, 34, 34)
                                .addComponent(jLabel7))
    ...
    private void saveMemberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveMemberActionPerformed
       ...
       String memberID1 = memeberID1.getText();
    ...
    private void checkOutLenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkOutLenActionPerformed
        ...
        if(checkOutLen.getSelectedIndex() == 1){
            maxDays = 21;
        }
        else if(checkOutLen.getSelectedIndex() == 2){
            maxDays = 7;
        }
        else{
        ...
        if(isbn3.isEmpty() || bookID1.isEmpty() || bookTittle1.isEmpty()|| authorPhoneNumber1.isEmpty()
            ...
            try{            
                if(maxDays==0) {
                    maxDays = 21;
                    JFrame frame = new JFrame();
                    JOptionPane.showMessageDialog(frame,"Select maximum checkout Length set to 21 days by default","Information",JOptionPane.INFORMATION_MESSAGE);
                 }
       ...
       String zip1 = zip22.getText();          
        ...
        if(street1.equals("") || city1.equals("") || firstName.equals("") || lastName.equals("") || phone.equals("") || memberID1.equals("") || state1.equals("") || zip1.equals("")){         
            JOptionPane.showMessageDialog(informationFrame, "All fields must be filled", "Error !!!!", JOptionPane.ERROR_MESSAGE);
             ...
             try{                  
                 if(controller.addLibMember(firstName,lastName, phone, memberID1, street1, city1, state1, zip1)){
                     System.out.println("works has executed");
                     memeberID22.setText("");
